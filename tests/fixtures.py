...
# Sample old format response data (current API structure)
SAMPLE_OLD_RESPONSE = {
    "search_result": {
        "hits": {
            "total": {"value": 331, "relation": "eq"},
            "hits": [
                {
                    "_id": "6965113",
                    "_source": {
...
# Sample new format response data (future API structure)
SAMPLE_NEW_RESPONSE = {
    "responses": [
        {
            "hits": {
                ...
                "hits": [
                    {
                        ...
                        "_source": {
                            "agent": [
                                {
                                    "logo_type": "new",
                                    "relative_url": "/makelaar/6380-leonie-evers-makelaars/",
                                    "is_primary": True,
                                    "logo_id": 214547831,
                                    "name": "Leonie Evers Makelaars",
                                    "association": "NVM",
                                    "id": 6380,
                                }
                            ],
                            ...
                            "address": {
                                "country": "NL",
                                "province": "Noord-Holland",
                                "wijk": "Zuid",  # New field in new format
                                "city": "Hilversum",
                                "neighbourhood": "Schrijverskwartier",
                                "municipality": "Hilversum",
                                "is_bag_address": True,
                                "house_number": "28",
                                "postal_code": "1215BC",
                                "street_name": "Hyacintenlaan",
                                "identifiers": [  # New field in new format
                                    "nl",
                                    "hilversum/straat-hyacintenlaan",
                                    "hilversum",
                                    "gemeente-hilversum",
                            ...
                            "zoning": "residential",
                            "publish_date": "2025-09-12T18:45:50.3300000+02:00",
                            "object_detail_page_relative_url": "/detail/koop/hilversum/huis-hyacintenlaan-28/43168350/",
                            "status": "none",
                            "number_of_rooms": 5,
                        },
                    }
...
EMPTY_RESPONSE = {"search_result": {"hits": {"hits": []}}}
